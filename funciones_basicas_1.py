...
def cantidad_de_glaciares_argentina():
    return 16968
print(cantidad_de_dias_o_meses_o_semanas_en_anio() + cantidad_de_glaciares_argentina()) # Imprime error no se puede concatenar, falta una funcion
'''
#3
def anio_independencia_chile():
    return 1810
    return 1851
print(anio_independencia_chile()) #Solo imprime el primer return >1810<

#4
def cantidad_de_departamentos_colombia():
    return(32)
    print(33) # No se muestra ya que esta dentro de la funcion
